...
import AnalisadorSintatico.AnaliseSint;
	 ...
	 */
			...
			public void actionPerformed(ActionEvent arg0) {
				JFileChooser fc= new JFileChooser();
                	...
                	File diretorio = fc.getSelectedFile();
                     pathFile=diretorio.getPath();
                     lblNomeDoArquivo.setText("Nome do Arquivo: "+diretorio.getName());
		...
		btnLexer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Lex.resultado ="";
				try {
					Lex.analisar(pathFile);
					//textPaneAnaSintática.setText(Lex.erro);
					Ana.analisaSint(pathFile,Lex.erro);
					textPaneAnaSintática.setText(Lex.erro);
